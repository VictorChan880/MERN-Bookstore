    ...
    return (
        ...
        >
            ...
            <div className='flex justify-start items-center gap-x-2'>
                <PiBookOpenTextLight className='text-red-300-text-2x-1' />
                <h2 className='my-1'>{book.title}</h2>
            </div>
            <div className='flex justify-start items-ceter gap-x-2'>
                <BiUserCircle className='text-red-300 text-2x1' />
                <h2 className='my-1'>{book.author}</h2>
            </div>
            <div className='flex justify-between items-ceter gap-x-2 mt-4 p-4'>
                <BiShow
